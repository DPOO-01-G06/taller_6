...
public class PanelBotones extends JPanel implements ActionListener
{
	...
	private final static String CAMBIAR_NOMBRE_CATEGORIAS = "CambiarNombreCategoria";
	
	private final static String ELIMINAR_AUTOR = "EliminarAutor";
	...
	public PanelBotones(InterfazLibreria interfazLibreria)
	{
		...
		agregarBoton(CAMBIAR_NOMBRE_CATEGORIAS, "Cambiar Nombre Categoria", "./data/iconos/autor2.png");
		agregarBoton(ELIMINAR_AUTOR, "Eliminar Autor", "./data/iconos/libros.png");
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (CAMBIAR_NOMBRE_CATEGORIAS.equals(comando))
		{
			ventana.cambiarNombreCat();
		}
		else if (ELIMINAR_AUTOR.equals(comando))
		{
			ventana.borrarLibro();
		}
	}
