...
public class InterfazLibreria extends JFrame
{
	 ...
	 */
	public void cambiarNombreCat() {
		String cambiarNombre= JOptionPane.showInputDialog("Porfavor ingrese el nombre a cambiar, se cambiara la categoria seleccionada");
		String nombreActual= panelCategorias.categoriaActual();
		try {
			libreria.cambiarNombreCat(cambiarNombre, nombreActual);
			panelCategorias.actualizarCategorias(libreria.darCategorias());
			SwingUtilities.updateComponentTreeUI(panelLibros);
		} catch (Exception e) {
	...
	public void borrarLibro() {
		String autores= JOptionPane.showInputDialog("Por favor ingrese los autores separados con coma");
		try {
		...
		cambiarCategoria(panelCategorias.darCategoria());
		SwingUtilities.updateComponentTreeUI(panelCategorias);
		SwingUtilities.updateComponentTreeUI(panelLibros);
	}
